...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-lg" style="background-color: #01633c;"><a href="gaji_input.php" style="color: white; text-decoration: none">+Gaji Karyawan</a></button>
