        ...
        <div class="modal-content modal-sm" style="margin:0 auto">
            ...
            <div class="modal-body">
                ...
                <select name="tahun" class="form-control" required>
                  <?php
                    $ahay = mysqli_query($kon, "SELECT DISTINCT YEAR(tgl) as tahun FROM jadwal ORDER BY tahun ASC");
                    while($baris = mysqli_fetch_array($ahay)) {
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-lg" style="background-color: #01633c;"><a href="jadwal_input.php" style="color: white; text-decoration: none">+Jadwal Maintenance</a></button>
                                    ...
                                    <?php $no=1; $query = mysqli_query($kon, "SELECT * FROM jadwal INNER JOIN user ON jadwal.id = user.id INNER JOIN barang ON jadwal.idbarang = barang.idbarang ORDER BY tgl DESC");
                                        while($data = mysqli_fetch_array($query)){ ?>
                                            <tr class="odd gradeX">
                                                    ...
                                                    <td><?= $data['cara'] ?></td>
                                                    <td>
                                                        <a href="jadwal_edit.php?idjadwal=<?php echo $data['idjadwal']; ?>" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i></a>
                                                        <a href="delete.php?idjadwal=<?php echo $data['idjadwal'] ?>" class="btn btn-success btn-sm"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                        <?php } ?>
