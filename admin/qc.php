    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-sm" style="margin:0 auto">
            ...
            <div class="modal-body">
                <form action="../report/laporanQC.php" target="_blank" method="post">
                <label>Bulan</label>
                <select name="bulan" class="form-control">
                  <option value="">Pilih</option>
                  <?php
                    $ahay = mysqli_query($kon, "SELECT DISTINCT MONTH(tglqc) as bulan FROM qc ORDER BY bulan ASC");
                ...
                <select name="tahun" class="form-control" required>
                  <?php
                    $ahay = mysqli_query($kon, "SELECT DISTINCT YEAR(tglqc) as tahun FROM qc ORDER BY tahun ASC");
                    while($baris = mysqli_fetch_array($ahay)) {
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-lg" style="background-color: #01633c;"><a href="qc_input.php" style="color: white; text-decoration: none">+Quality Check</a></button>
                                        ...
                                        while($data = mysqli_fetch_array($query)){ ?>
                                            <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="delete.php?idqc=<?php echo $data['idqc'] ?>" class="btn btn-success btn-sm"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                        <?php } ?>
