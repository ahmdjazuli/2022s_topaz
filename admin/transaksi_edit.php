<?php require('atas.php'); $notransaksi = $_GET['notransaksi'];
  $query = mysqli_query($kon, "SELECT * FROM transaksi JOIN user ON transaksi.id = user.id WHERE notransaksi = '$notransaksi'");
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button class="btn btn-lg" style="background-color: #01633c;"><a href="transaksi.php" style="color: white; text-decoration: none"> <i class="fa fa-angle-left"></i> Kembali</a></button></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6">
                    ...
                    <div class="panel-body">
                         <form role="form" action="" method="POST">
                            <div class="form-group">
                                <label>No. Transaksi - Instansi</label>
...
<?php
  if (isset($_POST['simpan'])) {
    ...
    $ubah = mysqli_query($kon,"UPDATE transaksi SET tgl = '$tgl' WHERE notransaksi = '$notransaksi'");
    if($ubah){
      ?> <script>alert("Berhasil Diubah");window.location='transaksi.php';</script> <?php
    }else{
      ?> <script>alert("Gagal Diubah");window.location='transaksi.php';</script> <?php
    }
  }
?>