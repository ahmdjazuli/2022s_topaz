...
<div class="form-group">
    ...
    <input type="datetime-local" name="tglqc" class="form-control" value="<?php echo date('Y-m-d\TH:i',strtotime($data['tglqc'])) ?>" required>
</div>
<div class="form-group">
